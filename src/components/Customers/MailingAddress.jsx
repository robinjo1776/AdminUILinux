          ...
          <div className="form-row" style={{ display: 'flex', gap: '1rem' }}>
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_address: e.target.value })}
            ...
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_city: e.target.value })}
                placeholder="City"
              />
            </div>
            ...
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_state: e.target.value })}
                placeholder="State"
              />
            </div>
          </div>
          <div className="form-row" style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_country: e.target.value })}
                placeholder="Country"
              />
            </div>
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_postal: e.target.value })}
            ...
            <div className="form-group" style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) => setformCustomer({ ...formCustomer, cust_mailing_unit_no: e.target.value })}
                placeholder="Unit No"
              />
            </div>
          </div>
