...
interface CustomerProps {
  ...
  setformCustomer: (customer: (prevCustomer: any) => any) => void; // Update `any` if you have a stricter type
}

const ViewMailingAddressForm: React.FC<CustomerProps> = ({ formCustomer, setformCustomer }) => {
