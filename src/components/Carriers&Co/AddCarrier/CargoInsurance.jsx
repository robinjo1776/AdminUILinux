    ...
    <fieldset className="form-section">
      ...
      <div className="form-row" style={{ display: 'flex', gap: '1rem' }}>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input type="text" value={carrier.ci_provider} onChange={(e) => setCarrier({ ...carrier, ci_provider: e.target.value })} id="ciProvider" placeholder='Cargo Insurance Provider'/>
        </div>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setCarrier({ ...carrier, ci_policy_no: e.target.value })}
            id="ciPolicyNo" placeholder='Policy Number'
          />
        </div>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setCarrier({ ...carrier, ci_coverage: e.target.value })}
            id="ciCoverage" placeholder='Coverage Amount'
          />
        </div>
      </div>
      <div className="form-row" style={{ display: 'flex', gap: '1rem' }}>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setCarrier({ ...carrier, ci_start_date: e.target.value })}
            id="ciStartDate"
          />
        </div>
        <div className="form-group" style={{ flex: 1 }}>
          <label htmlFor="ciEndDate">End Date</label>
          <input type="date" value={carrier.ci_end_date} onChange={(e) => setCarrier({ ...carrier, ci_end_date: e.target.value })} id="ciEndDate" />
        </div>
