...
const OrderDestination: React.FC<OrderDestinationProps> = ({ setOrder, order, destination, index, onRemove }) => {
  ...
  const getComponent = (type: string, fallback: string, components: google.maps.places.AddressComponent[]) => {
    ...
    <fieldset className="form-section">
      ...
      <div className="form-row" style={{ display: "flex", gap: "1rem", marginTop: "1rem" }}>
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input type="text" name="dimensions" value={destination.dimensions || ""} onChange={handleOrderChange} placeholder="Enter dimensions (e.g., 20x20x20 cm)" />
        </div>
      </div>
